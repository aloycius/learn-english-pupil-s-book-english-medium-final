# Learn English Pupil's Book Standard One (English Medium Schools) — ADT Bundle Reference
...
**Learn English Pupil's Book Standard One (English Medium Schools)** — This is an English-language primary school textbook for Standard One pupils in English-medium schools, published by the Tanzania Institute of Education, so it is clearly designed for early learners in Tanzania. It introduces beginning English through listening, speaking, phonics, letter-sound relationships, word reading, simple sentences, punctuation, and short stories and poems, using songs, repetition, picture-based activities, and oral practice. The book targets a very early elementary reading level and follows a structured, child-friendly approach that emphasizes basic communication, sound recognition, and gradual reading fluency.
...
├── LEARN-ENGLISH-PUPIL-S-BOOK-ENGLISH-MEDIUM-FINAL.db                    # SQLite database (pipeline state)
├── LEARN-ENGLISH-PUPIL-S-BOOK-ENGLISH-MEDIUM-FINAL.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Green Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, approving “Learn English Pupil’s Book Standard One (English Medium Schools)” as a textbook for Standard One in primary schools. It includes approval number 1162, the publisher and author as Tanzania Institute of Education, the ISBN, the approval date of 23rd October 2023, and the signature of the Commissioner for Education, Dr Lyabwene M. Mtabwa.",
  "gl001": "abroad",
  "gl001_def": "in or to another country"
}
```
...
```json
{
  "title": "Learn English Pupil's Book Standard One (English Medium Schools)",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
| Original PDF | `LEARN-ENGLISH-PUPIL-S-BOOK-ENGLISH-MEDIUM-FINAL.pdf` |
| Pipeline database | `LEARN-ENGLISH-PUPIL-S-BOOK-ENGLISH-MEDIUM-FINAL.db` (SQLite) |
